...
![Version](https://img.shields.io/badge/version-3.8.2-00caf5.svg?style=for-the-badge&labelColor=11111a)
...
Lincle is a clean, lightweight, privacy-first browser extension built for Mozilla Firefox, Chromium (Chrome, Brave, Edge, Opera), and Apple Safari to make browsing faster, safer, and less annoying. It automatically bypasses link shorteners, skips redirect countdown timers, and unlocks scroll-locked pages or invisible popup overlays without collecting any user data.
...
- **Metalab Editorial UI (Void Theme)**: Enjoy a minimalist, pure-black editorial interface with elegant typography, soft borders, and distraction-free dark mode controls.
...
- **Custom Theme Engine**: Personalize the extension popup and settings interface with 6 built-in color presets or create your own custom palette using direct HEX inputs and a 1-click auto-memorize feature.
...
- **14 Built-in Languages**: Native translation support for 14 languages with custom vector flags.
- **Privacy First**: Zero telemetry, zero analytics, and zero external network calls.

### Installation Guide

#### Mozilla Firefox (Official Add-on Store)
You can install Lincle directly from the official Firefox Add-ons store:
👉 **[Download Lincle on Firefox Add-ons (AMO)](https://addons.mozilla.org/en-US/firefox/addon/lincle/)**
...
Lincle, Mozilla Firefox, Chromium (Chrome, Brave, Edge, Opera) ve Apple Safari tarayıcılarında internette gezinirken karşılaştığınız sinir bozucu engelleri ortadan kaldırmak için geliştirilmiş hafif, yerel ve kullanıcı dostu bir eklentidir. Kısaltılmış linkleri, bekleme süreli yönlendirme sayfalarını ve reklam sitelerindeki popup engellerini siz daha sayfayı görmeden arka planda temizler.
...
- **Metalab Editorial Tasarım (Void Teması)**: İnce tipografi, saf siyah tonlar ve göz yormayan karanlık mod ile yenilenmiş editorial arayüzünün tadını çıkarın.
...
- **Özel Tema Düzenleyici**: Eklenti arayüzünü 6 farklı hazır tema ile kullanabilir ya da HEX renk girdilerini kullanarak kendi özel temanızı tasarlayabilirsiniz.
...
#### Mozilla Firefox (Resmi Eklenti Mağazası)
Lincle'ı doğrudan resmi Firefox Eklenti Mağazasından indirebilirsiniz:
👉 **[Firefox Add-ons (AMO) Üzerinden Lincle'ı İndir](https://addons.mozilla.org/en-US/firefox/addon/lincle/)**

*Manuel / Geliştirici Yüklemesi:*
1. Firefox'ta `about:debugging#/runtime/this-firefox` adresine gidin.
